...
for i in range(args.num_samples):
    ...
    texture_image_1 = control_net_pipe(prompt_embeds=control_embeds_1,
    ...
    texture_image_2 = control_net_pipe(prompt_embeds=control_embeds_2,
                    negative_prompt_embeds = negative_control_embeds,
                    image= control_net_img,
                    controlnet_conditioning_scale=controlnet_conditioning_scale,
                    height=height,
    ...
    input_img = composite_ingredients(texture_image_1,mask_1,texture_image_2,mask_2,burger_template)
